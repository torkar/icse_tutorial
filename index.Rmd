...
Let us design four models and see how well they compare concerning out of sample predictions. Except for the first model, we'll do prior predictive checks on all models. On the final model we'll also do a visual posterior predictive check. For all models we check three diagnostics, i.e., $\widehat{R}$, effective sample size, and traceplots. 
