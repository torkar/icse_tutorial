...
We see that one language (Language 3) is clearly lower than the other languages. In short, using Language 3 means that a project uses less effort. Since Language 3 clearly does not touch any of the other languages bars one could claim that it's a significant difference. But then there are many other things that could prove this to be false...
